...
<br><br>Add a new room</font>
<p><span class="error"></span></p>
<form method="POST" action="add.php">
Room name<br><input type="text" name="room" required >*<br>
<br>Room capacity<br><input type="int" name="cap" id="cap" required >*<br><br>
<input class="button" type="submit" name="submit" id="pass" value="add room">
</form>
</font>
</div>
</body>
