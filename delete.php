...
<br><br>Remove a room</font>
<?php
//connect to mysql database
$connection = mysqli_connect("localhost","root","saksham","room") or die("Error " . mysqli_error($connection));
?>  
<div align="center">
    <h1 class="sign-up-title">remove a room</h1>
...
<h3>Room Name:<input type="int" placeholder="choose a room" name="room" autocomplete="off" list="id1" required>
</h3>
<?php mysqli_close($connection); ?>
<input type="submit" type="button" value="remove" class="button" >
</form>
<center><a href = "admin.php" class="button"> back to home </a></center>
</font>
</div>
</body>
</html>
